...
export function AppShell({ children, tab, pendingCount, onTabChange, onOpenAdd, toast, mode }: AppShellProps) {
  return (
    <div style={{ minHeight: "100dvh", position: "relative", zIndex: 1 }}>
      ...
      <button
        ...
        style={{
          ...
          boxShadow: "0 20px 34px color-mix(in srgb, var(--accent) 28%, transparent)",
          cursor: "pointer",
          display: "flex",
          alignItems: "center",
